...
const RegisterForm = () => {
  ...
  return (
    ...
    <View style={styles.contact}>
          <Text style={styles.emailText}>For additional information or to request account deletion, please contact us at swmmiitd@gmail.com
          <TouchableOpacity onPress={handleEmailPress} style={styles.contactmail}>
            <Icon name="email" size={12} color="#A9A9A9" />
          </TouchableOpacity>
          </Text>
        </View>
        </View>
